...
\begin{figure}[H]
 ...
 \caption{Class distribution of mispriced vs non-mispriced snapshots (counts and proportions; only about 3.7\% are mispriced).}
\end{figure}
...
\begin{figure}[H]
 ...
 \caption{Confusion matrices at thresholds 0.50 (left) and 0.70 (right).}
\end{figure}
